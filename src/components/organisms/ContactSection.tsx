                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <a
                          ...
                          className="text-slate-900 dark:text-slate-100 hover:text-slate-600 dark:hover:text-slate-300 transition-colors"
                        >
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-900 dark:text-slate-100">Usually within 24 hours</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-900 dark:text-slate-100">Open to new opportunities</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-lg p-8 shadow-sm">
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      className="flex items-center justify-center w-12 h-12 bg-slate-100 dark:bg-slate-800 rounded-lg text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all"
