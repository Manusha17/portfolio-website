    ...
    <div className="relative flex min-h-screen items-center justify-center bg-slate-50 dark:bg-slate-800">
      <div className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="p-3 text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 transition-colors"
          ...
          {/* Placeholder for contact form - will be implemented in task 6 */}
          <AnimatedSection direction="up" delay={0.6}>
            <div className="bg-white dark:bg-slate-900 rounded-lg p-8 max-w-2xl mx-auto">
              <h3 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mb-4">
                Contact Form
              </h3>
              <p className="text-slate-600 dark:text-slate-300">
                Interactive contact form will be implemented in task 6.
              </p>
            </div>
          </AnimatedSection>
        </div>
